...
<body>
    <div class="container-fluid m-0 p-0">
        <!-- Navbar section -->
        <?php
            include_once "./views/includes/homepage_navbar.php";
        ?>
        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-dark" data-bs-ride="true">
            ...
            <div class="carousel-inner p-0">
                <div class="carousel-item active">
                    <img src="./img/living-white-room.jpg" class="d-block img-fluid" alt="...">
                </div>
                <div class="carousel-item ">
                    <img src="./img/scandinavian-living-room.jpg" class="d-block img-fluid" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="./img/living-room-blank-white.jpg" class="d-block img-fluid" alt="...">
                </div>
            </div>
                ...
                <div class="row text-center align-self-center">
                    ...
                    <div class="col box">
                        ...
                        <div class="card border-0 shadow-sm mb-5 mx-auto" style="width: 21rem;">
                            <img src="./img/Classic-Lamp.jpg" class="card-img-top img-fluid" alt="...">
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="row align-items-center">
                            <div class="col position-relative p-0 pe-xl-1" id="first-banner-div"
                                ...
                                <a class="" href="">
                                    <img src="./img/pink-armchair.jpg" class="img-fluid" alt="">
                                </a>
                    ...
                    <div class="col-12 col-xl-6">
                        <div class="row align-items-center">
                            <div class="col position-relative p-0 ps-xl-1" id="second-banner-div"
                                ...
                                <a class="" href="">
                                    <img src="./img/green-sofa.jpg" class="img-fluid" alt="">
                                </a>
                        ...
                        <div class="carou-product">
                            ...
                            <div id="carouselControls" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner shadow-sm">
                                    <div class="carousel-item active">
                                        <img src="./img/AMALFI-LOUNGE-CHAIR-1.jpg" class="img-fluid" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="./img/AMALFI-LOUNGE-CHAIR-2.jpg" class="img-fluid" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="./img/AMALFI-LOUNGE-CHAIR-3.jpg" class="img-fluid" alt="...">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="./img/AMALFI-LOUNGE-CHAIR-4.jpg" class="img-fluid" alt="...">
                                    </div>
                                </div>
